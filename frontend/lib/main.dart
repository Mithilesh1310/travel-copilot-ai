    ...
    showDialog(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setGoogleModalState) {
            return AlertDialog(
              ...
              content: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      'Enter your Google account email to authenticate and sync your profile securely.',
                    ...
                    if (isGoogleSubmitting)
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('Authenticate with Google', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                          onPressed: () async {
