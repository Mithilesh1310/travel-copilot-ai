...
class _MainDashboardScreenState extends State<MainDashboardScreen> {
      ...
      if (account != null) {
        ...
        if (mounted) {
          if (res['success'] == true && res['data'] != null) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('🌐 Google OAuth Verified! Welcome back, $_userName.'),
  ...
  void _showGoogleOAuthPortalDialog() {
            ...
            return AlertDialog(
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Google Identity Services Portal',
              ...
              content: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      'Enter your Google account email to authenticate and sync your profile securely with Travel Copilot AI.',
                    ...
                    if (isSubmitting)
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('Sign In with Google Account', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                          onPressed: () async {
