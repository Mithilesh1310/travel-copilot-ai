...
class SmartExploreService:
    ...
    def fetch_real_location_pois(cls, location_name: str, base_lat: float, base_lng: float) -> List[Dict[str, Any]]:
        ...
        # Factual place knowledge fallback for Kanpur & PSIT Kanpur if online live nodes are sparse
        if 'kanpur' in loc_lower or 'psit' in loc_lower:
            kanpur_factual_stops = [
                {
                    "id": "knp_1",
                    "name": "JK Temple (Juggilal Kamlapat Shrine), Kanpur",
                    "category": "Religious & Spiritual Shrine",
                    "lat": 26.4745,
                    "lng": 80.3060,
                    ...
                    "ai_reasoning": "Iconic white marble architectural marvel blending ancient and modern Hindu temple design.",
                    "ai_score": 99,
                    "image_url": "https://images.unsplash.com/photo-1548013146-72479768bada",
                    "description": "Magnificent marble temple complex dedicated to Lord Radha Krishna featuring five towers.",
                    "history_summary": "Constructed in 1960 by the JK Trust as a major cultural and architectural symbol of Kanpur.",
                    "facts": ["White Carrara Marble Carvings", "Five Distinct Sanctums", "Lush Landscaped Lawns"],
                    "architecture": "Neo-Nagara Marble Architecture",
                    "cultural_importance": "Spiritual heart and landmark of Kanpur city.",
                    "entry_fee": "Free Entry",
                    "opening_hours": "06:00 AM - 12:00 PM, 04:00 PM - 09:00 PM",
                    "best_visiting_time": "Morning or Evening Aarti",
                    "photo_tips": "Capture central spire lit up during evening twilight hours.",
                    "safety_tips": "Remove footwear before ascending marble steps.",
                ...
                {
                    "id": "knp_2",
                    "name": "Allen Forest Zoo & Botanical Sanctuary, Kanpur",
                    "category": "Nature & Botanical",
                    "lat": 26.4950,
                    "lng": 80.3120,
                    ...
                    "ai_reasoning": "One of North India's largest natural forest zoos spanning 190 acres of dense flora and lake habitats.",
                    "ai_score": 97,
                    "image_url": "https://images.unsplash.com/photo-1507525428034-b723cf961d3e",
                    "description": "Sprawling natural woodland zoo and botanical reserve housing tigers, leopards, rhinos, and avian species.",
                    "history_summary": "Established during the British era by Sir Allen and opened as a public zoo in 1971.",
                    "facts": ["190 Acre Natural Forest", "Botanical Lake", "Aquarium & Train"],
                    "architecture": "Natural Woodland Reserve",
                    "cultural_importance": "Primary eco-tourism hub and green lung of Kanpur.",
                    "entry_fee": "₹70 (Adults)",
                    "opening_hours": "09:00 AM - 05:00 PM (Closed Mondays)",
                    "best_visiting_time": "Late Morning",
                    "photo_tips": "Capture wildlife in open forest enclosures near central lake.",
                    "safety_tips": "Do not feed animals; comfortable walking shoes recommended.",
                    "accessibility": "Battery cart vehicles available.",
                    "nearby_amenities": {"toilets": True, "cafes": True, "parking": True, "metro": False},
                    "spending_estimate": {"entry": 70.0, "cart": 50.0}
                },
                {
                    "id": "knp_3",
                    "name": "Moti Jheel & Lakeside Promenade, Kanpur",
                    "category": "Scenic Waterfront",
                    "lat": 26.4770,
                    "lng": 80.3200,
                    "address": "Harsh Nagar, Kanpur, Uttar Pradesh 208012",
                    "visit_duration_mins": 60,
                    "estimated_cost": 0.0,
                    "travel_time_from_prev_mins": 12,
                    "travel_mode_from_prev": "Auto",
                    "scheduled_time": "02:00 PM",
                    "ai_reasoning": "Historic urban lake and landscaped gardens featuring boating, musical fountains, and children's park.",
                    "ai_score": 95,
                    "image_url": "https://images.unsplash.com/photo-1567157577867-05ccb1388e66",
                    "description": "Picturesque reservoir and public park surrounded by city civic structures and gardens.",
                    "history_summary": "Constructed during the British Raj to store water, now Kanpur's favorite recreational lake.",
                    "facts": ["Urban Lake Promenade", "Boating & Fountains", "Central Location"],
                    "architecture": "Urban Waterfront Park",
                    "cultural_importance": "Popular evening leisure retreat for Kanpur citizens.",
                    "entry_fee": "Free Entry (Boating ₹50)",
                    "opening_hours": "05:00 AM - 09:00 PM",
                    "best_visiting_time": "Late Afternoon",
                    "photo_tips": "Shoot fountain reflection across lake during golden hour.",
                    "safety_tips": "Supervise children near lake railing.",
                    "accessibility": "Paved level walkway.",
                    "nearby_amenities": {"toilets": True, "cafes": True, "parking": True, "metro": True},
                    "spending_estimate": {"boating": 50.0, "snacks": 50.0}
                },
                {
                    "id": "knp_4",
                    "name": "PSIT Kanpur Campus & Tech Innovation Hub",
                    "category": "Historical Monument",
                    "lat": 26.4674,
                    "lng": 80.2078,
                    "address": "NH-19, Bhauti, Kanpur, Uttar Pradesh 208020",
                    "visit_duration_mins": 60,
                    "estimated_cost": 0.0,
                    "travel_time_from_prev_mins": 20,
                    "travel_mode_from_prev": "Cab",
                    "scheduled_time": "03:45 PM",
                    "ai_reasoning": "Premier 116-acre engineering and technology campus featuring state-of-the-art auditoriums and green lawns.",
                    "ai_score": 94,
                    "image_url": "https://images.unsplash.com/photo-1548013146-72479768bada",
                    "description": "Sprawling 116-acre high-tech educational campus located on Kanpur-Agra highway.",
                    "history_summary": "Established in 2004 as Pranveer Singh Institute of Technology.",
                    "facts": ["116 Acre Green Campus", "State-of-art Tech Hub", "High-Tech Amphitheatre"],
                    "architecture": "Modern Institutional Architecture",
                    "cultural_importance": "Educational & technological pride of Kanpur region.",
                    "entry_fee": "Visitor Campus Access",
                    "opening_hours": "08:30 AM - 06:00 PM",
                    "best_visiting_time": "Afternoon Hours",
                    "photo_tips": "Photograph central academic plaza and landscaped lawns.",
                    "safety_tips": "Visitor check-in required at main security gate.",
                    "accessibility": "Wheelchair accessible campus ramps.",
                    "nearby_amenities": {"toilets": True, "cafes": True, "parking": True, "metro": False},
                    "spending_estimate": {"cafeteria": 100.0}
                },
                {
                    "id": "knp_5",
                    "name": "Bithoor Ganga Ghat & Brahmavart Sacred Riverfront",
                    "category": "Religious & Spiritual Shrine",
                    "lat": 26.6120,
                    "lng": 80.2710,
                    "address": "Bithoor, Kanpur District, Uttar Pradesh 209201",
                    "visit_duration_mins": 90,
                    "estimated_cost": 0.0,
                    "travel_time_from_prev_mins": 30,
                    "travel_mode_from_prev": "Cab",
                    "scheduled_time": "05:15 PM",
                    "ai_reasoning": "Ancient holy pilgrimage town on River Ganges associated with Sage Valmiki, Sita, and Nana Saheb Peshwa.",
                    "ai_score": 93,
                    "image_url": "https://images.unsplash.com/photo-1570168007204-dfb528c6958f",
                    "description": "Historic spiritual riverbank town housing Brahmavart Ghat, Valmiki Ashram, and 1857 revolt heritage.",
                    "history_summary": "Center of the 1857 First War of Independence led by Nana Saheb Peshwa.",
                    "facts": ["Birthplace of Luv & Kush", "Brahmavart Ghat", "1857 Revolt Center"],
                    "architecture": "Historic Riverfront Ghat Architecture",
                    "cultural_importance": "Major spiritual and national heritage landmark near Kanpur.",
                    "entry_fee": "Free Entry",
                    "opening_hours": "24 Hours Open",
                    "best_visiting_time": "Sunset Ganga Aarti",
                    "photo_tips": "Capture sunset reflections over the wide Ganges riverfront.",
                    "safety_tips": "Use caution on steps during evening river rituals.",
                    "accessibility": "Level upper promenade.",
                    "nearby_amenities": {"toilets": True, "cafes": True, "parking": True, "metro": False},
                    "spending_estimate": {"entry": 0.0, "boat": 100.0}
                }
            ]
            if len(pois) < 3:
                return kanpur_factual_stops
